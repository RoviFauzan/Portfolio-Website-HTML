...
function showSkills(category) {
    ...
    setTimeout(() => {
        ...
        selectedCategory.skills.forEach(skill => {
            let color = skill.proficiency < 50 ? "red" : skill.proficiency < 80 ? "orange" : "green";
            ...
            <div class="bar">
                <div class="card" onclick="flipCard(this)">
                    <div class="front">
                        ...
                        <span style="font-size: 1.5rem; font-weight: bold;">${skill.name}</span>
                    </div>
                    <div class="back">
                        <p style="font-size: 1.2rem; font-weight: bold;">Proficiency</p>
                        <div class="progress" style="--percent: ${skill.proficiency}; --color: ${color};">
                            ${skill.proficiency}%
                        </div>
                        <span style="font-size: 1.2rem; font-weight: bold;">${skill.name}</span>
                    </div>
                </div>
            </div>`;
        });
